...
void update_vaccine_table() throws SQLException{
    ...
    private void initComponents() {
        ...
        v_search = new javax.swing.JButton();
        ...
        vaccination.setBackground(new java.awt.Color(255, 255, 204));
        ...
        v_search.setBackground(new java.awt.Color(153, 153, 153));
        v_search.setFont(new java.awt.Font("Tekton Pro", 0, 14)); // NOI18N
        v_search.setText("SEARCH");
        v_search.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                v_searchMouseClicked(evt);
            }
        });
        ...
        vaccinationLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, vaccinationLayout.createSequentialGroup()
                ...
                .addGap(64, 64, 64)
                .addComponent(v_search, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(232, 232, 232))
            .addGroup(vaccinationLayout.createSequentialGroup()
                .addGap(15, 15, 15)
        ...
        vaccinationLayout.setVerticalGroup(
            ...
            .addGroup(vaccinationLayout.createSequentialGroup()
                ...
                .addGroup(vaccinationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(v_search, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 0, Short.MAX_VALUE))
        );

        jimp.add(vaccination, "card3");

        manage.setBackground(new java.awt.Color(255, 204, 255));
...
int key=0;
    ...
    private void v_searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_v_searchMouseClicked
        try
        {
        if(vregno.getText().isEmpty())
    {
            JOptionPane.showMessageDialog(this, "Enter the register number");
    } 
        String tf=vregno.getText();
        con=DriverManager.getConnection("jdbc:mysql://localhost:3306/pet_management","root","Jan06012023");
        PreparedStatement pst=con.prepareStatement("select * from vaccine where rtrim(vregno)=?");
       // Save=(PreparedStatement)con.prepareStatement("insert into vaccine values(?,?,?)");
    ...
    }//GEN-LAST:event_v_searchMouseClicked
    ...
    private javax.swing.JButton v_search;
